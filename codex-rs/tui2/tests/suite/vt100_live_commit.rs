...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match codex_tui2::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = codex_tui2::live_wrap::RowBuilder::new(20);
    ...
    codex_tui2::insert_history::insert_history_lines(&mut term, lines)
